...
export default class ProductSeeder extends BaseSeeder<ProductModel> {
  ...
  public async populate(): Promise<ProductModel[]> {
    ...
    const [rows] = await this.conn.execute<ProductModel[]>(
